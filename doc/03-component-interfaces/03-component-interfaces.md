...
Standard [clear(), transferFrom(), newInstance()]
|
| (extends)
|
v
TimedInputQueueKernel [enqueue(), dequeue(), length()]
|
| (extends)
|
v
TimedInputQueue [front(), duration(), isEmpty(), averageInterval(), removeOlderThan(), frequency()]
